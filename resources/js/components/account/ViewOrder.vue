        ...
        <div class="container innr-cont-area">
            <div class="row">
                <div class="col-sm-12 col-md-9 view-orderspage mt-15">
                    <h5><small>Order ID:</small> # {{orderDetails.order_code}} </h5><h5><small>Order Date :</small> {{orderDetails.created_at}}</h5>
                    ...
                    <div class="table-cvr">
                        <table>
                            ...
                            <tr>
                                ...
                                <th width="15%" style="text-align:center">Amount per unit</th>
                                ...
                                <td>
                                    <div class="item-nameimage-hold">
                                        ...
                                        <div class="cartpage-pro-values smallbtn">
                                            ...
                                            <div class="vendorname-m-over-cart"> Color
