        ...
        <table cellpadding="0" cellspacing="0" class="es-wrapper" width="100%">
            ...
            <tr>
                <td valign="top" class="esd-email-paddings">
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center" style="padding: 15px;background: #efefef;padding-top:5%; padding-bottom: 5%; border:1px solid #ccc;border-top: 0px; border-bottom:0px;">
                        <tbody>
                        <tr >
                            <td class="esd-stripe" align="center">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: 'Montserrat',arial, sans-serif; font-size: 14px; color: #000000; text-align: center; text-transform: uppercase; font-weight: normal;">
                                                        Dear {{$accountName}}, Your registration request has been not approved by ITC Promotions Management.
                                                        If you have any comments or questions, please <a href="{{URL('/contact')}}" target="_blank">contact us</a>
                                                    </td>
                                                </tr>
